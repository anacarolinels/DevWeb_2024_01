...
paragrafo.style.background = '#FBBEBA' //alterar cor de fundo no primeiro paragrafo 

//Busca a tag e a classe
let parClasse = (document.querySelector('p.exemplo').innerHTML = 'Mudei o texto aqui')
//innerHTML (modifica o conteudo)
...
}; //ao clicar no botão o fundo do ultimo paragrafo fica verde
