let form = document.getElementById('addForm') //Acessar o formulário pra adicionar os itens
let itemList = document.getElementById('items') //Acessar a lista de itens
let filter = document.getElementById('filter') //Buscar um elemento na lista 
